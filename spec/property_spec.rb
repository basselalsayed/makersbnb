...
describe Property do # a new instance of the Property class has an address postcode photo puid uid
  ...
  it 'initializes with a postcode' do
    expect(subject.postcode).to eq 'SW20 XXX'
  end
  ...
  describe '.all' do
    it 'returns  all of the properties' do # array of hashes 
      ...
      connection.exec("INSERT INTO properties(address, postcode, photo) VALUES('Crescent Road', 'SW20 XXX', 'www.imageshack.com/property');")
      connection.exec("INSERT INTO properties(address, postcode, photo) VALUES('Cambridge Road', 'SW18 XXX', 'www.imageshack.com/property2');")
      property = Property.all

      expect(subject_2.all.last.address).to eq('Cambridge Road')
      expect(subject_2.all.last.postcode).to eq('SW18 XXX')
    end
  ...
  describe '.create' do
    it 'creates a new property' do
      ...
      expect(subject_2.all.last.postcode).to eq 'SW19 PPP'
    end
